/* Generated from xz-embedded-master; do not edit implementation manually. */
#ifndef XZ_EMBEDDED_FEATURES
#define XZ_EMBEDDED_FEATURES
...
/* Project convenience API: memory-to-memory decompression. */
#ifdef __cplusplus
extern "C" {
#endif
