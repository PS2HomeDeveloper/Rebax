 ...
 * منفصلة عمداً عن node_interface_t الحقيقية بمجلد embedded/engine/resources/nodes/node_sources/
 ...
 * من سطر @NODE بكل ملف embedded/engine/resources/nodes/node_sources (ملفات .c) - بلا أي تعديل يدوي هنا
 * أو بـnode_registry.c. عقدة جديدة = ملف جديد بمجلد
 * embedded/engine/resources/nodes/node_sources فيه
...
#include "../embedded/engine/resources/nodes/node_sources/node_interface.h" /* Shared node property types; node implementations remain embedded resources. */
