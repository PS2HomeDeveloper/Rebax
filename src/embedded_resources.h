...
extern const unsigned char _binary_embedded_engine_tools_text_txt_start[];
extern const unsigned char _binary_embedded_engine_tools_text_txt_end[];

static inline size_t embedded_engine_tools_size(void) {
    return (size_t)(_binary_embedded_engine_tools_text_txt_end
                   - _binary_embedded_engine_tools_text_txt_start);
}
...
/* Core engine node-source archive, embedded in both build modes. */
extern const unsigned char _binary_embedded_engine_resources_nodes_node_sources_tar_xz_start[];
extern const unsigned char _binary_embedded_engine_resources_nodes_node_sources_tar_xz_end[];

static inline size_t embedded_node_sources_size(void) {
    return (size_t)(_binary_embedded_engine_resources_nodes_node_sources_tar_xz_end
                   - _binary_embedded_engine_resources_nodes_node_sources_tar_xz_start);
}
