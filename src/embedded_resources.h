 ...
 * ------------------------------------------------------------ */
extern const unsigned char _binary_embedded_toolchains_ps2dev_tar_xz_start[];
extern const unsigned char _binary_embedded_toolchains_ps2dev_tar_xz_end[];
...
#define REBAX_WEAK
#endif
extern const unsigned char _binary_embedded_toolchains_make_start[] REBAX_WEAK;
extern const unsigned char _binary_embedded_toolchains_make_end[] REBAX_WEAK;
extern const unsigned char _binary_embedded_toolchains_make_exe_start[] REBAX_WEAK;
extern const unsigned char _binary_embedded_toolchains_make_exe_end[] REBAX_WEAK;
static inline size_t embedded_make_size(void) {
    if (_binary_embedded_toolchains_make_start && _binary_embedded_toolchains_make_end)
        return (size_t)(_binary_embedded_toolchains_make_end-_binary_embedded_toolchains_make_start);
    if (_binary_embedded_toolchains_make_exe_start && _binary_embedded_toolchains_make_exe_end)
        return (size_t)(_binary_embedded_toolchains_make_exe_end-_binary_embedded_toolchains_make_exe_start);
    return 0;
}
static inline const unsigned char *embedded_make_start(void) {
    if (_binary_embedded_toolchains_make_start && _binary_embedded_toolchains_make_end) return _binary_embedded_toolchains_make_start;
    if (_binary_embedded_toolchains_make_exe_start && _binary_embedded_toolchains_make_exe_end) return _binary_embedded_toolchains_make_exe_start;
    return NULL;
}

static inline size_t embedded_ps2dev_size(void) {
    return (size_t)(_binary_embedded_toolchains_ps2dev_tar_xz_end
                   - _binary_embedded_toolchains_ps2dev_tar_xz_start);
}
