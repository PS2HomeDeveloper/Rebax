...
/* Moved here (out of original concatenation order) because Precomp.h,
 * right below, uses Z7_DIAGNOSTIC_IGNORE_BEGIN_RESERVED_MACRO_IDENTIFIER,
 * which this Compiler.h block defines. It must come first. */
